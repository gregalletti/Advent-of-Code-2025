...
with open(path) as f:
    ...
    print_blue(part_1())
    print(f"Completed 2025-3 PART 1 in {(time.time() - start_time) * 1000} ms\n")

    start_time = time.time()
    print_purple(part_2())
    print(f"Completed 2025-3 PART 2 in {(time.time() - start_time) * 1000} ms")